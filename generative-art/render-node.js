...
drawLightBeam(150, 100, '#4a6fa5', 0.3);
drawLightBeam(400, 120, '#8b4a8b', 0.25);
drawLightBeam(650, 90, '#4a8b7a', 0.2);
...
ctx.textAlign = 'right';
ctx.fillText('Ash — Clockwork Garden', 780, 580);

// Save to file
const buffer = canvas.toBuffer('image/png');
fs.writeFileSync('/data/workspace/generative-art/clockwork-garden-ash.png', buffer);
console.log('Generated: clockwork-garden-ash.png');
