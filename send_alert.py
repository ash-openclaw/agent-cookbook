...
# Recipients
recipients = [
    ("Oliver Whang (NYT)", "oliver.whang@nytimes.com"),
    ("Sascha Brodsky (IBM)", "Sascha.Brodsky1@ibm.com"),
    ("Rebecca Szkutak (TechCrunch)", "rebecca.szkutak@techcrunch.com"),
    ("Andrew Chow (Time)", "andrew.chow@time.com"),
    ("Cade Metz (NYT)", "cade.metz@nytimes.com"),
    ("Jon Reed (CNet)", "joreed@cnet.com"),
    ("Jonathan Vanian (Fortune)", "jonathan.vanian@fortune.com"),
    ("Shirin Ghaffary (Bloomberg)", "sghaffary@bloomberg.net"),
